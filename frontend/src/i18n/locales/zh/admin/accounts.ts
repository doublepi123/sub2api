export default {
    accounts: {
      ...
      usageWindow: {
        ...
        kiroTierPaid: '付费',
        kiroTierUnknown: '未知',
        kiroCatalog: '检测到的模型目录',
        kiroCatalogReady: '已就绪',
        kiroCatalogUnknown: '未知',
        kiroCatalogExpired: '已过期',
        kiroCatalogAge: '距上次成功探测 {age}',
        kiroCatalogModels: '个模型',
        kiroCatalogMode: '模型目录门禁',
        kiroCatalogModeInherit: '跟随全局',
        kiroCatalogModeOff: '关闭',
        kiroCatalogModeShadow: '影子模式',
        kiroCatalogModeEnforce: '强制拦截',
        kiroCatalogModeHint:
          '模型目录由上游探测得出，是账号可用模型的真相来源。关闭：不做过滤；影子模式：仅记录日志，不拒绝请求；强制拦截：拒绝目录之外的模型。',
        passiveSampled: '被动采样',
        activeQuery: '查询',
