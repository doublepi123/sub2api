export default {
    accounts: {
      ...
      usageWindow: {
        ...
        kiroTierFree: 'Free',
        kiroTierPaid: 'Paid',
        kiroTierUnknown: 'Unknown',
        kiroCatalog: 'Detected model catalog',
        kiroCatalogReady: 'ready',
        kiroCatalogUnknown: 'unknown',
        kiroCatalogExpired: 'expired',
        kiroCatalogAge: 'Last successful probe {age} ago',
        kiroCatalogModels: 'models',
        kiroCatalogMode: 'Model catalog gate',
        kiroCatalogModeInherit: 'Inherit global',
        kiroCatalogModeOff: 'Off',
        kiroCatalogModeShadow: 'Shadow',
        kiroCatalogModeEnforce: 'Enforce',
        kiroCatalogModeHint:
          'The catalog is detected from upstream and is the source of truth for this account. Off: no filtering. Shadow: log only, never rejects. Enforce: reject models outside the detected list.',
