...
const BADGE: Record<Platform, string> = {
  ...
  kiro: 'bg-teal-500/10 text-teal-700 border-teal-500/30 dark:text-teal-300',
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  kiro: 'bg-teal-500/10 text-teal-700 dark:bg-teal-500/10 dark:text-teal-300',
...
const TEXT: Record<Platform, string> = {
  ...
  kiro: 'text-teal-700 dark:text-teal-300',
...
const ICON: Record<Platform, string> = {
  ...
  kiro: 'text-teal-600 dark:text-teal-300',
  grok: 'text-zinc-800 dark:text-zinc-200',
...
const DISCOUNT: Record<Platform, string> = {
  ...
  kiro: 'bg-teal-100 text-teal-800 dark:bg-teal-900/40 dark:text-teal-300',
