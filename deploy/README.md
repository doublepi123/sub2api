...
curl -sSL https://raw.githubusercontent.com/doublepi123/sub2api/main/deploy/docker-deploy.sh | bash

# Or download first, then run
curl -sSL https://raw.githubusercontent.com/doublepi123/sub2api/main/deploy/docker-deploy.sh -o docker-deploy.sh
...
```bash
# Clone repository
git clone https://github.com/doublepi123/sub2api.git
cd sub2api/deploy
...
1. Download the latest release from [GitHub Releases](https://github.com/doublepi123/sub2api/releases)
