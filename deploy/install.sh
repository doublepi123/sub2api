...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/doublepi123/sub2api/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="doublepi123/sub2api"
...
Documentation=https://github.com/doublepi123/sub2api
