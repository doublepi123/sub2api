...
type SettingService struct {
	...
	// kiroModelCatalogRuntimeCache Kiro 模型目录门控运行时配置缓存（*cachedKiroModelCatalogRuntime）。
	kiroModelCatalogRuntimeCache atomic.Value
	kiroModelCatalogRuntimeSF    singleflight.Group
