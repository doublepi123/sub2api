...
type CompositeRouteRequest struct {
	...
	TargetPlatform string `json:"target_platform" binding:"required,oneof=anthropic openai gemini antigravity kiro grok kimi zhipu deepseek minimax opencode_go"`
